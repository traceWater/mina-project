  ...
  return (
    <div>
      ...
      <div className="aboutHeroContainer">
        <img
          id="aboutBlueLeafImage"
          src={
            process.env.PUBLIC_URL + "/AboutImages/Frame-AGBpDkZaG5cRpbaw.png"
          }
          alt="HeroImage"
        />
      </div>
      ...
      <div className="aboutWorkingEthosWrapper">
        <img
      ...
      <div className="aboutOrangeMaterialsWrapper">
        <div>
          <img
            id="aboutImageOrange"
            src={
              process.env.PUBLIC_URL + "/AboutImages/pp-AoP0LMM1VPTawJL6.avif"
            }
