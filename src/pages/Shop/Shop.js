            ...
            <div key={p}>
              <Link to={`/shop/${p}`}>
                <img
                  id="row-2"
                  src={
                    process.env.PUBLIC_URL + "/ShopImages/greyVasePurpleRag.png"
                  }
                  alt="'Bulb' Vase"
                />
              </Link>
            ...
            <div key={p}>
              <Link to={`/shop/${p}`}>
                <img
                  id="row-2"
                  src={
                    process.env.PUBLIC_URL + "/ShopImages/yellowVaseCactus.png"
                  }
                  alt="'Candy' Flowerpot"
                />
              </Link>
          ...
          {[9].map((p) => (
            <div key={p}>
              <Link to={`/shop/${p}`}>
                <img
                  id="row-3"
                  src={process.env.PUBLIC_URL + "/ShopImages/tanTribelDisc.png"}
                  alt="'Wave' Vase"
                />
              </Link>
